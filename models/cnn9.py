...
def CNN(x):
    weights = {'W_conv1':tf.Variable(tf.random_normal([3,3,3,1,64])),
               ...
               'W_conv3':tf.Variable(tf.random_normal([3,3,3,128,256])),
               'W_conv4':tf.Variable(tf.random_normal([3,3,3,256,256])),
               'W_conv5':tf.Variable(tf.random_normal([3,3,3,256,512])),
               'W_conv6':tf.Variable(tf.random_normal([3,3,3,512,512])),
               'W_conv7':tf.Variable(tf.random_normal([3,3,3,512,512])),
               'W_conv8':tf.Variable(tf.random_normal([3,3,3,512,512])),
